    ...
    <section className="bg-white">
      <div className="max-w-2xl px-4 py-8 mx-auto lg:py-16">
        <div className="flex items-center mb-4 gap-2">
          ...
          <h1 className="font-bold">{definicao.termo} - Editar definição</h1>
        </div>
        <form action={update}>
          <div className="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
            ...
            <div className="sm:col-span-2">
              ...
              <input type="text" name="urlVideo" id="urlVideo" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="https://[...]" defaultValue={definicao.urlVideo ?? undefined} />
            </div>
          </div>
